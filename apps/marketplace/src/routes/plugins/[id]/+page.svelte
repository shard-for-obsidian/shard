...
<div class="max-w-5xl mx-auto">
	<div class="mb-6">
		<a href="{base}/" class="text-sm text-muted-foreground hover:text-foreground">
			← Back to marketplace
		</a>
	</div>
			...
			<Card.Root>
				...
				<Card.Content class="space-y-4">
					...
					{#if plugin.minObsidianVersion}
						<div>
							<p class="text-xs text-muted-foreground">Min Obsidian Version</p>
								...
								<div class="border rounded-lg p-4">
									<div class="flex items-start justify-between mb-2">
										...
										<div class="text-right">
											<p class="text-sm text-muted-foreground">{formatSize(version.size)}</p>
										</div>
									</div>
